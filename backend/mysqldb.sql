...
CREATE TABLE `stock-beheer`.`Bestelling` (`id` INT NOT NULL AUTO_INCREMENT, `aanmaak` DateTime NOT NULL,`winkelId` INT,`winkelEnkelString` VARCHAR(30),`aantal` INT NOT NULL,`totaleKostPrijsExclBtw` Int NOT NULL,`url` VARCHAR(50) NOT NULL,`leverTijd` Int NOT NULL,`leveringsAdres` VARCHAR(45) NOT NULL,`omschrijving` VARCHAR(100),`artikelNr` VARCHAR(45) NOT NULL,`projectId` Int NOT NULL,`rqNummer` BIGINT, `goedgekeurdDoorCoach` Boolean NOT NULL,`bestellingDoorFDGeplaatst` Date,`verwachteAankomst` Date,`bestellingOntvangen` Date, `werkelijkBetaald` Int, `opmerking` VARCHAR(100), PRIMARY KEY(`id`), UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE);
